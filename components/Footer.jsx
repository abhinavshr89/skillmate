...
function Footer() {
  return (
    <footer className="bg-gradient-to-br from-slate-900/50 via-purple-900/20 to-slate-900/50 backdrop-blur-sm border-t border-purple-500/20 text-white">
      <div className="max-w-7xl mx-auto px-6 py-12">
        {/* Main Footer Content */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          {/* Company Info */}
          <div className="space-y-4 bg-gradient-to-br from-slate-800/30 to-purple-900/10 backdrop-blur-sm border border-purple-500/10 rounded-xl p-6">
            ...
            <p className="text-gray-300 leading-relaxed">
              Your AI-powered career companion. Advance your professional journey with personalized guidance and cutting-edge tools.
            </p>
          ...
          {/* Features */}
          <div className="space-y-4 bg-gradient-to-br from-slate-800/30 to-purple-900/10 backdrop-blur-sm border border-purple-500/10 rounded-xl p-6">
            <h4 className="text-lg font-semibold text-purple-300">Features</h4>
            <ul className="space-y-2 text-gray-300">
              <li>
                <Link href="/interview" className="hover:text-purple-400 transition-colors">
                  AI Quizzes
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/ai-cover-letter" className="hover:text-purple-400 transition-colors">
        ...
        {/* Bottom Footer */}
        <div className="border-t border-purple-500/20 pt-8 bg-gradient-to-br from-slate-800/20 to-purple-900/10 backdrop-blur-sm rounded-xl p-6 mt-8">
